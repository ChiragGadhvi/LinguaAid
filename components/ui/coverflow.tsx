...
export function CoverFlow({
  ...
  return (
    <motion.div
      ref={containerRef}
      className={`relative w-full flex flex-col justify-center items-center bg-transparent focus:outline-none touch-none ${
    ...
    >
      <div
        ...
        style={{ transformStyle: 'preserve-3d', height: itemHeight }}
      >
      ...
      <div className="mt-3 pb-10 flex flex-col items-center justify-center z-40 transition-opacity duration-300 pointer-events-none">
        <motion.div
