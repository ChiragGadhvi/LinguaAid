...
const COVERFLOW_ITEMS: CoverFlowItem[] = [
  { id: 1, image: "/documents/Indian.png",         title: "Indian Government Doc",  subtitle: "Benefits & Welfare Scheme" },
  { id: 2, image: "/documents/German.png",          title: "German Medical Letter",  subtitle: "Hospital Discharge Notice" },
  { id: 3, image: "/documents/Brazilian.png",       title: "Brazilian Official Doc", subtitle: "Social Assistance Approval" },
  { id: 4, image: "/documents/Japanese.png",        title: "Japanese Residence Doc", subtitle: "Municipal Certificate" },
  { id: 5, image: "/documents/United States.png",   title: "US Eviction Notice",     subtitle: "Housing Authority Notice" },
];
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#000" }}>
      ...
      <section className="grid-pattern hero-section" style={{
        ...
        {/* Tilted Doc — popping out top-left */}
        <motion.div
          drag
          dragSnapToOrigin
          dragElastic={0.15}
        ...
        >
          <Image src="/documents/Brazilian.png" alt="Brazilian Doc" fill style={{ objectFit: "cover", pointerEvents: "none" }} />
        </motion.div>

        {/* Tilted Doc — emerging bottom-right */}
        <motion.div
          drag
          dragSnapToOrigin
          dragElastic={0.15}
        ...
        >
          <Image src="/documents/Indian.png" alt="Indian Doc" fill style={{ objectFit: "cover", pointerEvents: "none" }} />
        </motion.div>
        ...
        <div style={{ maxWidth: "800px", width: "100%", textAlign: "center", position: "relative", zIndex: 10 }}>
          ...
          <h1 className="hero-heading" style={{
            ...
            letterSpacing: "-1.5px", marginBottom: "20px", color: "#fff",
          }}>
          ...
          <p style={{
            fontSize: "clamp(10px, 1.8vw, 15px)", color: "#888",
          ...
          <div style={{ display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a href="#how-it-works" className="btn-secondary" style={{
              ...
              gap: "8px", fontSize: "14px", padding: "12px 26px", textDecoration: "none",
            }}>
              How It Works
            </a>
          </div>
          ...
          <div style={{ marginTop: "48px", display: "flex", gap: "24px", justifyContent: "center", flexWrap: "wrap" }}>
            {["50+ Languages", "Free to Start", "Instant Results"].map((l) => (
              <div key={l} style={{ display: "flex", alignItems: "center", gap: "6px", color: "#fff", fontSize: "12px", fontWeight: "500" }}>
      ...
      {/* ── DOCUMENT TYPES ── */}
      <section id="features" ref={ref("features")} style={{ padding: "64px 24px", background: "#000" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          {/* Cards — same style as How It Works steps */}
          <div className="steps-grid" style={{ marginBottom: "64px" }}>
            {DOCUMENT_TYPES.map(({ icon: Icon, label, desc }, i) => (
              <div key={label} className="glass-card" style={{
                ...
                transform: visible.has("features") ? "translateY(0)" : "translateY(24px)",
                ...
                <h3 style={{ fontSize: "16px", fontWeight: "700", marginBottom: "8px", color: "#fff" }}>{label}</h3>
        ...
        <div style={{ width: "100%", height: "600px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", paddingTop: "40px" }}>
          <CoverFlow
        ...
        <div style={{ textAlign: "center", marginTop: "-8px", paddingBottom: "12px" }}>
          <a
            ...
            style={{
              ...
              letterSpacing: "0.04em", display: "inline-flex", alignItems: "center", gap: "5px",
      ...
      {/* ── FUNNY AD SECTION ── */}
      <section id="funny-ad" ref={ref("funny-ad")} style={{ padding: "80px 24px", textAlign: "center", borderBottom: "1px solid #111" }}>
      ...
      {/* ── FEATURES ── */}
      <section id="features-grid" ref={ref("features-grid")} style={{ padding: "64px 24px", maxWidth: "1100px", margin: "0 auto" }}>
        <div style={{ marginBottom: "40px" }}>
      ...
      <section id="languages" ref={ref("languages")} style={{
        padding: "64px 24px", background: "#050505",
      ...
      <section style={{ padding: "80px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: "520px", margin: "0 auto" }}>
          <div className="glass-card" style={{ padding: "48px 32px" }}>
            ...
            <h2 style={{ fontSize: "clamp(22px, 3vw, 32px)", fontWeight: "800", letterSpacing: "-0.8px", marginBottom: "12px", color: "#fff" }}>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ borderTop: "1px solid #111", padding: "40px 24px", display: "flex", flexDirection: "column", alignItems: "center", gap: "24px" }}>
        ...
        <div style={{ display: "flex", gap: "24px" }}>
          <a href="https://github.com/ChiragGadhvi/LinguaAid" target="_blank"
            style={{ color: "#555", transition: "color 0.2s" }}
            onMouseEnter={(e) => e.currentTarget.style.color = "#fff"}
            onMouseLeave={(e) => e.currentTarget.style.color = "#555"}>
            GitHub
          </a>
          <a href="https://dev.to/chiraggadhvi/i-built-a-document-translator-in-48-hours-heres-what-lingodev-changed-5cdd" target="_blank"
            style={{ color: "#555", transition: "color 0.2s" }}
            onMouseEnter={(e) => e.currentTarget.style.color = "#fff"}
            onMouseLeave={(e) => e.currentTarget.style.color = "#555"}>
            Blog
